...
public class ST_Demo {
    ...
    @Test
    public void ST___D___MASTER_FULL() throws InterruptedException {
    ...
    @Test
    public void ST___E___ACESSAR_EMAIL() throws InterruptedException {
...
/*        System.out.println("Acessar email resgatar senha enviada");
    ...
    @Test
    public void ST___F___ADMIN_FULL() throws InterruptedException {
...
////////////////////CREATE NEW GRUPO COMERCIAL GESTAO////////////////////
    ...
    @Test
    public void ST___G___INSERT_USER_ADMIN_TENANT() throws InterruptedException {
        ...
        WebDriverWait wait = new WebDriverWait(navegador, 10);
        WebElement element;
        wait.until((ExpectedConditions.visibilityOfElementLocated(By.xpath("(//i[contains(@class,'v-icon notranslate')])[4]"))));
   ...
   /* @Test
    public void ST___G___ADD_CDP() throws InterruptedException, MalformedURLException {
